...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of LoadingViewController.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/LoadingViewController'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Sapozhnik Ivan' => 'sapozhnik.ivan@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/LoadingViewController.git', :tag => s.version.to_s }
